<h1 align="center">Hi there, I'm Siddartha Bandi 👋</h1>
 
<h3 align="center">Data Scientist · AI Engineer · ML/DL Researcher</h3>
...
I'm an **MS Data Science candidate at the University of North Dakota (UND)**, specializing in machine learning, deep learning, and scalable data engineering. I build systems that extract intelligence from complex, high-dimensional data — from 35 years of satellite imagery to clinical medical images to financial transaction streams.
 
- 🔬 Currently: Graduate researcher in ML/DL at UND
- 🌱 Exploring: Foundation models, geospatial AI, and MLOps pipelines
- 💡 Passionate about: Turning raw data into real-world decisions
- 💼 Open to: Data Science, AI/ML Engineering, and Data Engineering roles
...
> Hierarchical two-stage fraud detection framework on the Kaggle Credit Card Fraud dataset  
> **Stack:** Random Forest · XGBoost · Isolation Forest · Autoencoder · LSTM  
> *MS Data Science Capstone — University of North Dakota*
 
### 🧠 Deep Learning for Medical Image Analysis
> Semantic segmentation and object detection on clinical medical images  
> **Stack:** PyTorch · ResNet · YOLO · U-Net
 
### 🌍 Global Economic Trends Visualization
> Interactive visualization of economic indicators across 150+ countries  
> **Stack:** Tableau · Python · Pandas
 
### 🛰️ Vegetation Trend Analysis — Fort Berthold Reservation
> NDVI/EVI satellite trend analysis (1990–2025) using Mann-Kendall statistics  
> **Stack:** Python · GeoPandas · Rasterio · Matplotlib
...
|------|-------------|----------|
| Graduate Research Assistant | University of North Dakota | 2024 – Present |
